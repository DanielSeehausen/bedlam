...
module.exports =
  ...
  explosionCanvas: explosionCanvas
  comboMode: comboMode
  ...
  enable: ->
    ...
    @comboModeEnabledSubscription = atom.config.observe 'bedlam.comboMode.enabled', (value) =>
      @isComboMode = value
  ...
  prepareEditor: ->
    ...
    @explosionCanvas.setupCanvas @editor, @editorElement
